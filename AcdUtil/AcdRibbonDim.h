...
*  \author Eric Charles
*
* $Header: /nfs/slac/g/glast/ground/cvs/AcdUtil/AcdUtil/AcdRibbonDim.h,v 1.9 2008/02/20 00:09:12 echarles Exp $
*/
...
public:
  ...
  /**
   **/  
  void getSegmentsIndices(const HepVector3D& dir, bool upward, int& start, int& end, int& dir);
